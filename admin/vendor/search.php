...
<?php
    if(isset($_POST['submit'])) {
        ...
        $query = "SELECT * FROM  appointment WHERE doctor_username='$doctor_username' and appoint_id LIKE '%".$search."%' || patient_name LIKE '%".$search."%' || patient_mobile_no LIKE '%".$search."%' || patient_name LIKE '%".$search."%' || patient_gender LIKE '%".$search."%' || appoint_time  LIKE '%".$search."%' ";
